...
Route::group(['middleware' => ['auth', 'admin']], function () {
	...
	Route::get('/info-tec/{sistt_id}', [App\Http\Controllers\Admin\SistemasTecnicosController::class, 'create']);
	...
	Route::get('/consultar-sist/{sistt_id}', [App\Http\Controllers\Admin\SistemasTecnicosController::class, 'consultarsistema']);
